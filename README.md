...
### <strong>1. カーネル空間（Kernel Space）</strong>
...
### <strong>2. ユーザー空間（User Space）</strong>
...
| 順番 | トピック                                   | 学ぶこと                                          |
| ---- | ------------------------------------------ | ------------------------------------------------- |
| 01   | [process](./01-process.md)                 | プログラムが「動いている状態」とは何か            |
| 02   | [fork-exec](./02-fork-exec.md)             | 新しいプログラムを起動する仕組み                  |
| 03   | [signal](./03-signal.md)                   | プログラムに「合図」を送る仕組み                  |
| 04   | [thread](./04-thread.md)                   | 1つのプログラムの中で複数の処理を同時に行う仕組み |
| 05   | [file-descriptor](./05-file-descriptor.md) | OS がファイルやデバイスを扱う方法                 |
| 06   | [stdio](./06-stdio.md)                     | プログラムの「入力」と「出力」                    |
| 07   | [ipc](./07-ipc.md)                         | プロセス間でデータをやり取りする仕組み            |
...
### <strong>1. Linux 自体が C で書かれている</strong>
...
### <strong>3. 「なぜ他の言語は楽なのか」がわかる</strong>
...
### <strong>1. プログラムの始まり：main 関数</strong>
...
### <strong>3. #include と #define</strong>
...
### <strong>6. エラー処理の基礎：errno と perror()</strong>
...
### <strong>7. プログラムの終了：exit() と EXIT_SUCCESS / EXIT_FAILURE</strong>
...
### <strong>9. 標準エラー出力：stderr と fprintf()</strong>
